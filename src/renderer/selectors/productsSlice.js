...
import { getProducts, insertProduct as insertProduct_db,insertProducts as insertProducts_db, updateProductById as updateProductById_db, deleteProductById as deleteProductById_db } from '../api/db'
    ...
    reducers: {
        ...
        addOneProductsUpdating(state,action) {
            ...
            if (productWaitUpdating.id in state.productsUpdating === false) {
                state.productsUpdating[productWaitUpdating.id] = productWaitUpdating
            } 
        },
...
export const { clearProductsUpdating, addOneProductsUpdating,setProductNoFilter,setSupplierNameFilter } = productsSlice.actions
