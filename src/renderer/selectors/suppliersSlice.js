...
import { getSuppliers,insertSupplier as insertSupplier_db,updateSupplierById as updateSupplierById_db,deleteSupplierById as deleteSupplierById_db } from '../api/db'
...
export const selectFilteredSuppliers = createSelector(
    ...
    (filterInfo,suppliers) => {
        if (filterInfo) {
            return suppliers.filter((supplier)=>supplier.name.includes(filterInfo))
